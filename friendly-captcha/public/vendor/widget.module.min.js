...
function r(t, e, r, i, o, n, a = !1, A, s) {
...
function A(t) {
  ...
  for (let i = 0; i < e; i += 3) {
    const e = t[i + 0],
      ...
      a = t[i + 2];
    (r += o.charAt(e >>> 2)),
      (r += o.charAt(((3 & e) << 4) | (n >>> 4))),
      (r += o.charAt(((15 & n) << 2) | (a >>> 6))),
      (r += o.charAt(63 & a));
  }
  return (
    e % 3 == 2
...
"undefined" != typeof navigator &&
  ((s = navigator), (l = s.userAgent.toLowerCase()));
const g = {
    text_init: " Aktiverer...",
...
class _ {
  constructor(t, e = {}) {
    if (
      ...
      (this.opts = Object.assign(
        {
          ...
          solutionFieldName:
            t.dataset.solutionFieldName || "frc-captcha-solution",
        },
        e
      )),
      (this.e = t),
      ...
      let t = u[this.opts.language.toLowerCase()];
      void 0 === t &&
        (console.error(
      ...
      this.lang = Object.assign(Object.assign({}, u.en), this.opts.language);
    (t.innerText = this.lang.text_init),
      ...
      this.init(
        "auto" === this.opts.startMode || "auto" === this.e.dataset.start
      );
  }
  init(t) {
    var e;
    if (this.hasBeenDestroyed)
      ...
      t
        ? ((e = () => this.start()),
          t.addEventListener("focusin", e, { once: !0, passive: !0 }))
        : console.log(
  ...
  makeButtonStart() {
    ...
    t &&
      (t.addEventListener("click", () => this.start(), {
        once: !0,
        passive: !0,
      }),
  ...
  async start() {
    ...
    if (
      (function () {
        let t = !0;
        try {
          (t = PluginArray.prototype === s.plugins.__proto__),
            s.plugins.length > 0 &&
              (t = t && Plugin.prototype === s.plugins[0].__proto__);
        } catch (t) {}
        return (
      ...
      try {
        (this.e.innerHTML =
          ...
          (A = this.lang),
          r(o, t, !0, A.text_fetching, ".FETCHING", void 0, !0))),
              ...
              i = (function (t) {
                ...
                for (let r = 0, o = 0; r < e; r += 4) {
                  const e = a[t.charCodeAt(r + 0)],
                    ...
                    A = a[t.charCodeAt(r + 2)],
                    s = a[t.charCodeAt(r + 3)];
                  (i[o++] = (e << 2) | (n >> 4)),
                    (i[o++] = ((15 & n) << 4) | (A >> 2)),
                    (i[o++] = ((3 & A) << 6) | (63 & s));
                }
            ...
            await (async function (t, e, r) {
              ...
              for (let t = 0; t < i.length; t++)
                try {
                  const r = await c(
                    i[t] + "?sitekey=" + e,
                    { headers: [["x-frc-client", "js-0.9.7"]], mode: "cors" },
                    2
                  );
                  if (r.ok) return (await r.json()).data.puzzle;
                  {
                    ...
                    if (t === i.length - 1)
                      throw Error(
                        `Response status ${r.status} ${r.statusText} ${
                          e ? e.errors : ""
                        }`
                      );
                  }
  ...
  handleDone(t) {
    this.valid = !0;
    const e = `${this.puzzle.signature}.${this.puzzle.base64}.${A(
      t.solution
    )}.${A(t.diagnostics)}`;
    return (
...
function f() {
  ...
  const e = (function () {
    ...
    return (
      0 === t.length &&
        console.warn(
          "FriendlyCaptcha: No div was found with .frc-captcha class"
        ),
      t
    );
  })();
